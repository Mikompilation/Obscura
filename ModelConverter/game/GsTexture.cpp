...
Texture *LoadTim2GsTexture(SGDTRI2FILEHEADER *pTRI2HeadTop)
{
  ...
  gsHelper.UploadPSMCT32(pTRI2HeadTop->gsli.bitbltbuf.DBP, 
                         ...
                         std::vector<uint8_t>(image_color_index, image_color_index + pTRI2HeadTop->uiVif1Code_DIRECT.size * 100));
  
  auto image_data = gsHelper.DownloadPSMCT32(pTRI2HeadTop->gsli.bitbltbuf.DBP, 
                           pTRI2HeadTop->gsli.bitbltbuf.DBW, 
                           pTRI2HeadTop->gsli.trxpos.DSAX, 
                           pTRI2HeadTop->gsli.trxpos.DSAY, 
                           pTRI2HeadTop->gsli.trxreg.RRW, 
